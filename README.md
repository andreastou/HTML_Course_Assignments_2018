# HTML_Course_Assignments_2018 (2017-2018)
...
**ΠΡΟΣΟΧΗ!!!** Πρέπει ***όσοι δεν έχουν δηλώσει τα αποθετήριά τουςστην 4η Εργαστηριακή Άσκηση του E-Class***  να ολοκληρώσουν την υποβολή των στοιχείων που απαιτούνται!

1. Πρέπει όσοι δεν έχουν δηλώσει τα αποθετήριά τους στην 4η Εργαστηριακή Άσκηση του E-Class να ολοκληρώσουν την υποβολή των στοιχείων που απαιτούνται!
2. Τα ονόματα καταλόγων πρέπει να είναι στα ΑΓΓΛΙΚΑ - ΧΩΡΙΣ ΚΕΝΑ και ΧΩΡΙΣ ΕΠΕΚΤΑΣΗ!  π.χ. Askisi1, Askisi-1, Askisi_1
3. Tα ονόματα των αρχείων πρέπει να είναι στα ΑΓΓΛΙΚΑ - ΧΩΡΙΣ ΚΕΝΑ και για τα αρχεία HTML η επέκταση είναι .html π.χ. askisi1.html
4. To αρχείο README.md θα έχει τα εξής στοιχεία:
	- Ονοματεπώνυμο
	- Αριθμό Μητρώου
